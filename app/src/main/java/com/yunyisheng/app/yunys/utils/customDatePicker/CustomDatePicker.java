package com.yunyisheng.app.yunys.utils.customDatePicker;
...
public class CustomDatePicker {
    ...
    private TextView tv_cancle, tv_select, hour_text, minute_text, year_text, mouth_text, day_text;
    ...
    private void initView() {
        ...
        mouth_text = (TextView) datePickerDialog.findViewById(R.id.month_text);
     ...
     * 设置日期控件是否显示时和分
     */
    public void showSpecificTime(boolean isShow) {
        if (canAccess) {
            if (isShow) {
                disScrollUnit();
