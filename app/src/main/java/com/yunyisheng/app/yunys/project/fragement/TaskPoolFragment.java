...
public class TaskPoolFragment extends BaseFragement<TaskListPresent> implements TaskAdapter.Callback {
    ...
    public void setListener() {
        noDataImgTask.setOnClickListener(this);
    }
   ...
   public void setNoData(){
       ...
       noDataImgTask.setImageResource(R.mipmap.no_data);
       noDataTask.setVisibility(View.VISIBLE);
   }
    public void setNoNetwork(){
        taskListView.setVisibility(View.GONE);
        noDataImgTask.setImageResource(R.mipmap.no_network);
        noDataTask.setVisibility(View.VISIBLE);
    }
    public void showList(){
        noDataTask.setVisibility(View.GONE);
