...
public class UnCeHandler implements Thread.UncaughtExceptionHandler {
    ...
    /** CrashHandler实例 **/
    private static final UnCeHandler INSTANCE = new UnCeHandler();
...
//        }.start();
        //出现异常清空上传数据库
        //GreenDaoManager.getInstance().clearMyUpLoad();
        // 收集设备参数信息
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                ...
                FileOutputStream fos = new FileOutputStream(getCacheDir()+ File.separator + fileName);
    ...
    private String getCacheDir() {
        File dir = new File(fileCache.getCacheDir(),"Log");
        if (!dir.exists()) {
            dir.mkdirs();
        }
