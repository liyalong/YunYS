...
public class RefreshableView extends LinearLayout {
    ...
    private int refreshTargetTop = -150;
 ...
 //   private Long refreshTime = null;
    ...
    private void init() {
        ...
        downTextString = ConstantManager.PullDownLabel;
        releaseTextString = ConstantManager.REFRESH_RELEASE;
    }
    ...
    private void refresh() {
         ...
         downTextView.setText(ConstantManager.RefreshingDownLabel);
...
//        }
        ...
        if(lp.topMargin >  0){
            downTextView.setText(ConstantManager.REFRESH_RELEASE);
            refreshIndicatorView.setImageResource(R.drawable.default_ptr_flip);
        }else{
            downTextView.setText(ConstantManager.PullDownLabel);
            refreshIndicatorView.setImageResource(R.drawable.default_ptr_flip);
        }
