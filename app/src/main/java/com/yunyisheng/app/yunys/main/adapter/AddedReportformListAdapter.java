...
public class AddedReportformListAdapter extends SimpleListAdapter<ReportFormBean.ListBean, AddedReportformListAdapter.ViewHolder> {

    public AddedReportformListAdapter(Context context, List<ReportFormBean.ListBean> data) {
        super(context, data);
    }
    ...
    protected int getLayoutId() {
        return R.layout.baobiao_added_item;
    }
