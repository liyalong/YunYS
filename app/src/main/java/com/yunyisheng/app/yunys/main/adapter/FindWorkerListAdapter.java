...
public class FindWorkerListAdapter extends SimpleListAdapter<FindWorkerBean.respBodyBean, FindWorkerListAdapter.ViewHolder> {

    public FindWorkerListAdapter(Context context, List<FindWorkerBean.respBodyBean> data) {
        super(context, data);
    }
