...
public class AddressPickerView extends RelativeLayout implements View.OnClickListener {
    ...
    private void sure() {
        if (mSelectProvice != null &&
            ...
            if (mOnAddressPickerSureListener != null) {
                mOnAddressPickerSureListener.onSureClick(mSelectProvice.getName() + " " + mSelectCity.getId() + " " + mSelectDistrict.getPid() + " ",
                        mSelectProvice.getId(), mSelectCity.getName(), mSelectDistrict.getPid());
            }
        } else {
                ...
                case 1:
                    ...
                    if (mSelectProvice != null) {
                        for (YwpAddressBean.AddressItemBean itemBean : mYwpAddressBean.getCity()) {
                            if (itemBean.getPid().equals(mSelectProvice.getId()))
                ...
                case 2:
                    ...
                    if (mSelectProvice != null && mSelectCity != null) {
                        for (YwpAddressBean.AddressItemBean itemBean : mYwpAddressBean.getDistrict()) {
                            if (itemBean.getPid().equals(mSelectCity.getId()))
                                mRvData.add(itemBean);
                        }
                    } else {
            ...
            switch (tabSelectPosition) {
                case 0:
                    if (mRvData.get(position) != null &&
                            mSelectProvice != null &&
                            mRvData.get(position).getId().equals(mSelectProvice.getId())) {
                ...
                case 1:
                    if (mRvData.get(position) != null &&
                            mSelectCity != null &&
                            mRvData.get(position).getId().equals(mSelectCity.getId())) {
                        holder.mTitle.setTextColor(defaultSelectedColor);
                    }
                    break;
                case 2:
                    if (mRvData.get(position) != null &&
                            mSelectDistrict != null &&
                            mRvData.get(position).getId().equals(mSelectDistrict.getId())) {
                        holder.mTitle.setTextColor(defaultSelectedColor);
                    }
                    break;
            }
    ...
    public interface OnAddressPickerSureListener {
        void onSureClick(String address, Integer id, String name, Integer pid);
    }
